...
- Managed executable launchers and their adjacent metadata are trusted local projections. `sm apply` refuses to replace an unmanaged command with the same name.
